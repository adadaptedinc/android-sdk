 ...
 */
public class AdditContentPayloadParser {
    private static final String LOGTAG = AdditContentPayloadParser.class.getName();

    private final Activity activity;

    public AdditContentPayloadParser(final Activity activity) {
